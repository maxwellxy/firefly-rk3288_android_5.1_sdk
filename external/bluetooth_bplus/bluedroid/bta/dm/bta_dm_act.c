...
#ifdef BT_BK3515A
    APPL_TRACE_DEBUG2("bta_dm_search_start avoid_scatter=%d, rs_res = %d ", bta_dm_cfg.avoid_scatter, p_data->search.rs_res);
    if (bta_dm_cfg.avoid_scatter && (p_data->search.rs_res == BTA_DM_RS_NONE) && bta_dm_check_av(BTA_DM_API_SEARCH_EVT))
    {
