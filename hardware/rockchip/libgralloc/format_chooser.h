...
/* Android pixmel format private range start from 0x100 */
...
typedef enum
{
	...
	GRALLOC_ARM_FORMAT_INTERNAL_INDEXED_AFBC_SPLITBLK_LAST=GRALLOC_ARM_FORMAT_INTERNAL_INDEXED_YV12_AFBC_SPLITBLK,
	...
	GRALLOC_ARM_FORMAT_INTERNAL_INDEXED_YUV420_AFBC,
...
typedef enum
{
	...
	/* Compressed extended YUV formats */
	GRALLOC_ARM_HAL_FORMAT_INDEXED_YUV420_AFBC,
