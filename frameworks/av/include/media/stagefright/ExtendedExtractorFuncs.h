...
typedef sp<MediaExtractor> (*MediaExtractorFactory)(const sp<DataSource> &source, const char* mime);
...
typedef void (*SnifferArrayFunc)(Vector<DataSource::SnifferFunc> &Sniffers, int *count);
