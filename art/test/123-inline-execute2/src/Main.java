    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i <= 360; i += 45) {
            ...
            System.out.println("StrictMath.sin(" + d + ") = "
                    + StrictMath.sin(d));
            System.out.println("StrictMath.sinh(" + d + ") = "
                    + StrictMath.sinh(d));
            System.out.println("StrictMath.asin(" + d + ") = "
                    + StrictMath.asin(d));
            System.out.println("StrictMath.cos(" + d + ") = "
                    + StrictMath.cos(d));
            System.out.println("StrictMath.cosh(" + d + ") = "
                    + StrictMath.cosh(d));
            System.out.println("StrictMath.acos(" + d + ") = "
                    + StrictMath.acos(d));
            System.out.println("StrictMath.tan(" + d + ") = "
                    + StrictMath.tan(d));
            System.out.println("StrictMath.tanh(" + d + ") = "
                    + StrictMath.tanh(d));
            System.out.println("StrictMath.atan(" + d + ") = "
                    + StrictMath.atan(d));
        ...
        for (int j = -3; j <= 3; j++) {
            double e = (double) j;
            System.out.println("StrictMath.cbrt(" + e + ") = "
                    + StrictMath.cbrt(e));
            System.out.println("StrictMath.log(" + e + ") = "
                    + StrictMath.log(e));
            System.out.println("StrictMath.log10(" + e + ") = "
                    + StrictMath.log10(e));
            System.out.println("StrictMath.log1p(" + e + ") = "
                    + StrictMath.log1p(e));
            System.out.println("StrictMath.exp(" + e + ") = "
                    + StrictMath.exp(e));
            System.out.println("StrictMath.expm1(" + e + ") = "
                    + StrictMath.expm1(e));
        ...
        System.out.println("StrictMath.ceil(0.0001) = "
                + StrictMath.ceil(0.0001));
        System.out.println("StrictMath.floor(0.0001) = "
                + StrictMath.floor(0.0001));
        System.out.println("StrictMath.nextAfter(1.0, 2.0) = "
                + StrictMath.nextAfter(1.0, 2.0));
        System.out.println("StrictMath.rint(0.5000001) = "
                + StrictMath.rint(0.5000001));
